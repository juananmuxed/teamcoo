<template>
  <v-card max-width="500" class="mx-auto" ref="form">
    <v-card-title class="headline font-weight-medium text-uppercase"
      >Login {{ web.name }}</v-card-title
    >
        ...
        <v-row>
          <v-col cols="12">
            <span class="subtitle-1"
              ...
              <a @click="goToSignin()">Sign Up</a></span
            ><br />
            <span class="subtitle-1"
              >Do not remember your password?
              <a @click="goToRemeberme()">Remember me</a></span
            >
          </v-col>
        </v-row>
      </v-container>
