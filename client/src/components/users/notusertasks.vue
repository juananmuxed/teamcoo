    ...
    <v-row>
        ...
        >
            ...
            <template v-slot:default="props">
                <v-row>
                    <v-col cols="12" md="6" xl="3" class="pa-3" v-for="(task , index) in props.items" :key="index">
                        <v-card>
                            <v-img
                                v-if="task.image != ''"
                                height="200"
                            ...
                            <v-card-text>
                                <template v-if="task.interests.length != 0">
                                    <v-row>
                                        <h3 class="pa-1"><span class="text-uppercase font-weight-light">Interests</span></h3>
                                        <v-col cols="12">
                                ...
                                <template v-if="task.usersjoined.length != 0">
                                    <v-row>
                                        <h3 class="pa-1"><span class="text-uppercase font-weight-light">Volunteers</span></h3>
                                        <v-col cols="12" class="pa-0">
                                            <v-avatar left v-for="(user , index) in task.usersjoined" :key="index" class="ma-1">
                                                <v-tooltip
                                                    top
                                                >
        ...
        <template v-if="loginuser.rol.value == 'coor' || loginuser.rol.value == 'admin' || loginuser.rol.value == 'volu'">
                ...
                <template v-slot:default="props">
                    <v-row>
                        <template v-for="(task , index) in props.items">
                            <v-col cols="12" md="6" xl="3" class="pa-3" :key="index + '-own'" v-if="task.creator.id == loginuser.id || task.usersjoined.some(u => u.id == loginuser.id)">
                                <v-card>
                                    <v-img
                                        v-if="task.image != ''"
                                        height="200"
            ...
            <v-col cols="12" class="pa-3">
                ...
                >
                    <template v-slot:activator="{ on }">
                        <v-btn block small color="primary" height="120" class="headline" v-on="on">
