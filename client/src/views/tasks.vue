<template>
  <v-container class="pa-10" fluid>
    ...
    <v-row>
      <v-col cols="12">
        <v-data-table :items="tasks.filter(t => !t.secret)" :headers="headers" :loading="loading">
    ...
    <v-row class="text-center">
      <v-col>
        <p class="display-1 font-weight-thin text-uppercase">Private Tasks</p>
      </v-col>
    </v-row>
    <v-row>
      <v-col cols="12">
